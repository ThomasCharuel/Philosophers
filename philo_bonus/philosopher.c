...
/*   Updated: 2024/01/20 12:26:46 by tcharuel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_bool philosopher_is_alive(t_philosopher *philosopher)
{
	...
	if (current_time - philosopher->last_eating_time > philosopher->simulation->time_to_die)
	{
...
void	philosopher_routine(t_simulation *simulation, unsigned int philosopher_id)
{
	...
	philosopher.last_eating_time = get_current_time();
